    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippingPrice', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('order', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='address', to='base.order')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
